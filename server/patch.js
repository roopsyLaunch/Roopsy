...
@@ -259,6 +249,13 @@ async function availableSlots(req, res) {
...
+  });
   ...
   const existing = await Booking.find({
     barberId: barber._id,
@@ -325,6 +322,17 @@ async function verifyOtp(req, res) {
...
@@ -370,6 +378,127 @@ async function verifyOtp(req, res) {
...
fs.writeFileSync('patch.diff', diffText);
