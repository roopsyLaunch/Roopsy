...
const BANNER_IMAGE = "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=500&auto=format&fit=crop&q=80";

export function BeautyParlorListScreen({ navigation }) {
  ...
  const load = useCallback(async () => {
    try {
      const params = { businessContext: "beauty_parlor" };
      if (gpsCoords) {
      ...
      console.error("BeautyParlorListScreen load error:", err);
    }
  }, [gpsCoords]);
  ...
  const filteredParlors = items.filter(parlor => {
    const matchesSearch = parlor.shopName?.toLowerCase().includes(searchQuery.toLowerCase()) || 
                          parlor.address?.city?.toLowerCase().includes(searchQuery.toLowerCase()) ||
                          parlor.address?.line1?.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    <View style={styles.header}>
      <View style={styles.topRow}>
        ...
        <View style={styles.headerTitleContainer}>
          ...
          <View>
            <Text style={styles.headerTitle}>Beauty Parlours</Text>
            <Text style={styles.headerSubtitle}>Find & book the best beauty parlour near you</Text>
          </View>
        </View>
      ...
      <View style={styles.searchRow}>
        <View style={styles.searchBox}>
          ...
          <TextInput 
            ...
            placeholder="Search beauty parlours near you..."
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.pillScroll}>
        {CATEGORIES.map(cat => {
          ...
          return (
            ...
            >
              <Ionicons name={cat.icon} size={16} color={isActive ? "#db2777" : "#64748b"} style={{ marginRight: 6 }} />
  ...
  const renderSectionTitle = () => (
    <View style={styles.sectionTitleRow}>
      <Text style={styles.sectionTitle}>Top Beauty Parlours Near You</Text>
      <Pressable>
    ...
    <View style={styles.trustContainer}>
      <View style={styles.trustItem}>
        <View style={styles.trustIconCircle}>
          <Ionicons name="shield-checkmark-outline" size={24} color="#db2777" />
        </View>
        <Text style={styles.trustTitle}>Verified Parlours</Text>
        <Text style={styles.trustDesc}>Certified & hygienic salons</Text>
      </View>
      <View style={styles.trustItem}>
        <View style={styles.trustIconCircle}>
          <Ionicons name="sparkles-outline" size={24} color="#db2777" />
        </View>
        <Text style={styles.trustTitle}>Premium Products</Text>
        <Text style={styles.trustDesc}>Top branded cosmetics</Text>
      </View>
      <View style={styles.trustItem}>
        <View style={styles.trustIconCircle}>
      ...
      <View style={styles.trustItem}>
        <View style={styles.trustIconCircle}>
          <Ionicons name="headset-outline" size={24} color="#db2777" />
        </View>
    ...
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            const services = item.specialties || ["Bridal", "Facial", "Hair Spa", "Makeup"];
            ...
            return (
              <Pressable
                style={styles.card}
                onPress={() => navigation.navigate("BeautyParlorDetail", { barberId: pId, shopName: item.shopName })}
              >
                ...
                <View style={styles.cardInfo}>
                  <View style={styles.cardHeader}>
                    <View style={styles.shopNameRow}>
                      <Text style={styles.shopName} numberOfLines={1}>{item.shopName || "Beauty Parlour"}</Text>
                      <Ionicons name="checkmark-circle" size={16} color="#db2777" style={{ marginLeft: 4 }} />
                    </View>
                  ...
                  <Text style={styles.specialtyText} numberOfLines={1}>
                    {item.businessCategory || "Makeup & Beauty Specialist"}
                  </Text>
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyTitle}>No beauty parlours found</Text>
              <Text style={styles.emptyText}>There are no beauty parlours available in your area matching your criteria.</Text>
            </View>
          }
        />
      )}
...
const styles = StyleSheet.create({
  ...
  iconCircle: { width: 40, height: 40, borderRadius: 20, backgroundColor: "#fce7f3", justifyContent: "center", alignItems: "center", marginRight: 12 },
  ...
  pillActive: { backgroundColor: "#fce7f3", borderColor: "#fbcfe8" },
  pillText: { fontSize: 13, fontWeight: "600", color: "#64748b" },
  pillTextActive: { color: "#db2777" },
  ...
  viewAll: { fontSize: 13, fontWeight: "600", color: "#db2777" },
  ...
  serviceTagText: { fontSize: 10, color: "#db2777", fontWeight: "600" },
  ...
  bookBtn: { backgroundColor: "#db2777", paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 },
  ...
  trustIconCircle: { width: 48, height: 48, borderRadius: 24, backgroundColor: "#ffffff", justifyContent: "center", alignItems: "center", marginBottom: 12, shadowColor: "#db2777", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 8, elevation: 2 },
